...
public class FieldConstants {
  ...
  /** Returns the nearest own-alliance trench center based on robot position. */
  public static Translation2d getNearestTrenchCenter(
      Translation2d robotPos, boolean isRedAlliance) {
    Translation2d[] candidates =
        isRedAlliance
            ? new Translation2d[] {Trench.redTopCenter, Trench.redBottomCenter}
            : new Translation2d[] {Trench.blueTopCenter, Trench.blueBottomCenter};
    return robotPos.getDistance(candidates[0]) < robotPos.getDistance(candidates[1])
        ? candidates[0]
        : candidates[1];
  }
