  ...
  public void periodic() {
    ...
    for (int cameraIndex = 0; cameraIndex < io.length; cameraIndex++) {
      ...
      for (var observation : inputs[cameraIndex].poseObservations) {
        ...
        if (observation.type() == PoseObservationType.QUESTNAV) {
          // QuestNav uses fixed standard deviations (SLAM-based, very accurate)
          linearStdDev = questNavLinearStdDev;
          angularStdDev = questNavAngularStdDev;
        } else {
          // AprilTag-based: scale by distance and tag count
          double stdDevFactor =
        ...
        // Apply camera-specific multiplier
