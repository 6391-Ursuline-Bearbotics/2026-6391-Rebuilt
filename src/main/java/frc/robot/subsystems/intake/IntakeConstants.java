...
public final class IntakeConstants {
  ...
  public static final double deployCurrentThreshold = 15.0; // Stator amps indicating hard stop
  ...
  public static final double rollerIntakeVelocityRPM = 600.0;
  public static final double rollerEjectVelocityRPM = -600.0;
