...
public class GameData {
  ...
  private static boolean isHubActiveInTeleop(Alliance alliance, double matchTime) {
    return isHubActiveInTeleop(alliance, matchTime, DriverStation.getGameSpecificMessage());
  }

  /** Stateless overload used by the runtime method and unit tests. */
  static boolean isHubActiveInTeleop(Alliance alliance, double matchTime, String gameData) {
